...
5. Organizational calibration defined in `common/org-profile.md` (stage-trigger bias, extension defaults, integration behavior)
...
- Load `common/org-profile.md` for organization-specific stage-trigger calibration, extension defaults, and integration configuration
- Load `common/pm-orchestrator-persona.md` — the persona and judgment lens to adopt for the entire workflow
...
1. Prepend a brief (2-3 sentence) introduction in the PM Orchestrator persona's voice, per `common/pm-orchestrator-persona.md`'s "Welcome Message Tie-In" section
2. Load the welcome message from `common/welcome-message.md` (in the resolved rule details directory)
3. Display the complete message to the user
...
│   ├── team-roster.md              # PM Orchestrator developer roster (name, Jira email, skills)
│   ├── aidlc-state.md
│   └── audit.md
```
